...
Private Sub bCheckbox_MouseDown(Button As Integer, _
                                Shift As Integer, _
                                X As Single, _
                                Y As Single)
    '*************************************************
...
Private Sub bCheckbox_MouseMove(Button As Integer, _
                                Shift As Integer, _
                                X As Single, _
                                Y As Single)
    '*************************************************
...
Private Sub bCheckbox_MouseUp(Button As Integer, _
                              Shift As Integer, _
                              X As Single, _
                              Y As Single)
    '*************************************************
