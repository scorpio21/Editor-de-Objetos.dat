...
Private Declare Function CreateWindowExA _
                Lib "user32.dll" (ByVal dwExStyle As Long, _
...
Private Declare Function GdipCreatePen2 _
...
Private Declare Function GdipFlattenPath _
                Lib "GdiPlus.dll" (ByVal mPath As Long, _
                                   ByVal mMatrix As Long, _
                                   ByVal mFlatness As Single) As Long

Private Declare Function GdipFillPath _
                Lib "GdiPlus.dll" (ByVal mGraphics As Long, _
                                   ByVal mBrush As Long, _
                                   ByVal mPath As Long) As Long

Private Declare Function GdipGetPointCount _
                Lib "GdiPlus.dll" (ByVal mPath As Long, _
                                   ByRef mCount As Long) As Long

Private Declare Function GdipRotatePathGradientTransform _
                Lib "GdiPlus.dll" (ByVal mBrush As Long, _
                                   ByVal mAngle As Single, _
                                   ByVal mOrder As MatrixOrder) As Long

Private Declare Function GdipTranslatePathGradientTransform _
                Lib "GdiPlus.dll" (ByVal mBrush As Long, _
                                   ByVal mDx As Single, _
                                   ByVal mDy As Single, _
                                   ByVal mOrder As MatrixOrder) As Long

Private Declare Function GdipTranslateTextureTransform _
                Lib "GdiPlus.dll" (ByVal mBrush As Long, _
                                   ByVal mDx As Single, _
                                   ByVal mDy As Single, _
                                   ByVal mOrder As MatrixOrder) As Long
...
Private Declare Function GdipFillEllipseI _
                Lib "GdiPlus.dll" (ByVal mGraphics As Long, _
                                   ...
                                   ByVal mX As Long, _
                                   ByVal mY As Long, _
                                   ByVal mWidth As Long, _
                                   ByVal mHeight As Long) As Long

Private Declare Function GdipCreatePath _
                Lib "GdiPlus.dll" (ByVal mBrushMode As Long, _
                                   ByRef mPath As Long) As Long
...
Private Declare Function GdipSetPenEndCap _
                Lib "GdiPlus.dll" (ByVal mPen As Long, _
                                   ByVal mEndCap As LineCap) As Long

Private Declare Function GdipSetPenStartCap _
                Lib "GdiPlus.dll" (ByVal mPen As Long, _
                                   ByVal mStartCap As LineCap) As Long

Private Declare Function GdipDrawEllipse _
                Lib "GdiPlus.dll" (ByVal mGraphics As Long, _
                                   ByVal mPen As Long, _
                                   ByVal mX As Single, _
                                   ByVal mY As Single, _
                                   ByVal mWidth As Single, _
                                   ByVal mHeight As Single) As Long
...
Private Declare Function GdipSaveGraphics _
                Lib "GdiPlus.dll" (ByVal mGraphics As Long, _
                                   ByRef mState As Long) As Long

Private Declare Function GdipRestoreGraphics _
                Lib "GdiPlus.dll" (ByVal mGraphics As Long, _
                                   ByVal mState As Long) As Long

Private Declare Function GdipCreateLineBrushFromRectWithAngleI _
                Lib "GdiPlus.dll" (ByRef mRect As RectL, _
                                   ByVal mColor1 As Long, _
                                   ByVal mColor2 As Long, _
                                   ByVal mAngle As Single, _
                                   ByVal mIsAngleScalable As Long, _
                                   ByVal mWrapMode As WrapMode, _
                                   ByRef mLineGradient As Long) As Long
...
Private Declare Function GdipCreateFont _
                Lib "GdiPlus.dll" (ByVal mFontFamily As Long, _
                                   ByVal mEmSize As Single, _
                                   ByVal mStyle As Long, _
                                   ByVal mUnit As Long, _
                                   ByRef mFont As Long) As Long
...
Private Declare Function GdipDrawString _
                Lib "GdiPlus.dll" (ByVal mGraphics As Long, _
                                   ByVal mString As Long, _
                                   ByVal mLength As Long, _
                                   ByVal mFont As Long, _
                                   ByRef mLayoutRect As RECTF, _
                                   ByVal mStringFormat As Long, _
                                   ByVal mBrush As Long) As Long

Private Declare Function GdipCreateFontFamilyFromName _
                Lib "gdiplus" (ByVal Name As Long, _
                               ByVal fontCollection As Long, _
                               fontFamily As Long) As Long

Private Declare Function GdipDeleteFontFamily _
                Lib "gdiplus" (ByVal fontFamily As Long) As Long

Private Declare Function GdipGetGenericFontFamilySansSerif _
                Lib "GdiPlus.dll" (ByRef mNativeFamily As Long) As Long

Private Declare Function GdipCreateStringFormat _
                Lib "gdiplus" (ByVal formatAttributes As Long, _
                               ByVal language As Integer, _
                               StringFormat As Long) As Long

Private Declare Function GdipSetStringFormatFlags _
                Lib "GdiPlus.dll" (ByVal mFormat As Long, _
                                   ByVal mFlags As StringFormatFlags) As Long

Private Declare Function GdipSetStringFormatAlign _
                Lib "gdiplus" (ByVal StringFormat As Long, _
                               ByVal Align As StringAlignment) As Long

Private Declare Function GdipSetStringFormatLineAlign _
                Lib "GdiPlus.dll" (ByVal mFormat As Long, _
                                   ByVal mAlign As StringAlignment) As Long
...
Private Declare Function GdipDeleteStringFormat _
                Lib "GdiPlus.dll" (ByVal mFormat As Long) As Long
...
Private Declare Function GdipDrawArc _
                Lib "GdiPlus.dll" (ByVal mGraphics As Long, _
                                   ...
                                   ByVal mY As Single, _
                                   ByVal mWidth As Single, _
                                   ByVal mHeight As Single, _
                                   ByVal mStartAngle As Single, _
                                   ByVal mSweepAngle As Single) As Long
...
Public Function DrawGradientArc(ByVal hGraphics As Long, _
                                ...
                                ByVal ColorsAngle As Long, _
                                ByVal mStartAngle As Single, _
                                ByVal mSweepAngle As Single) As Boolean
...
Private Function DrawText(ByVal hGraphics As Long, _
                          ...
                          Optional HAlign As CaptionAlignmentH, _
                          Optional VAlign As CaptionAlignmentV, _
                          Optional bWordWrap As Boolean) As Long
...
Private Function ShiftColor(ByVal clrFirst As Long, _
                            ByVal clrSecond As Long, _
                            ByVal Proportion As Long) As Long
...
Private Sub Draw()
    ...
    With RectL
        ...
        If m_CenterVisible Then
            If m_CenterGradient Then
                GdipCreateLineBrushFromRectWithAngleI RectL, RGBtoARGB(m_CenterColor1, m_CenterColor1Opacity), RGBtoARGB(m_CenterColor2, m_CenterColor2Opacity), 90 - m_GradientAngle, 0, WrapModeTileFlipXY, hBrush
            Else
    ...
    If m_PB_ColorGradient Then
        GdipCreateLineBrushFromRectWithAngleI RectL, RGBtoARGB(m_PB_Color1, m_PB_Color2Opacity), RGBtoARGB(m_PB_Color2, m_PB_Color1Opacity), 90 - m_GradientAngle, 0, WrapModeTileFlipXY, hBrush
